  ...
  <div class="relative flex items-top justify-center min-h-screen bg-gray-100 sm:items-center sm:pt-0">
    ...
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
      ...
      <b-form-group
        ...
        label-for="input-1"
        description="Por favor ingresar un correo electronico valido."
        class="mt-4">
        <b-form-input
          id="input-1"
          v-model="form.email"
      ...
      <b-form-group id="input-group-3" label="Contraseña:" label-for="input-3">
        <b-form-input type="password" id="input-3" aria-describedby="password-help-block" v-model="form.password" placeholder="Contraseña" required></b-form-input>
        <b-form-text id="password-help-block">
          Su contraseña debe tener mas de 8 caracteres
    </b-form-text>
      </b-form-group>
      <div class="col-12 d-flex justify-content-center">
        <b-button class=" m-1" type="submit" variant="primary">Registrarse</b-button>
    ...
    methods: {
      onSubmit(event) {
        ...
        if(this.form.password.length < 8){
          alert('debes ingresar minimo 8 caracteres en la contraseña');
          ...
          try{
            ...
            .then((response) => {
              ...
              if(response.statusText === "Created"){
                alert('Su usuario se ha registrado exitosamente');
                this.onReset(event);
              }
            });
          }catch(e){
